...
EFI_STATUS efi_main(EFI_HANDLE ImageHandle, EFI_SYSTEM_TABLE *SystemTable)
{
	...
	// Dump emulator state after csmwrap_video_init
	printf("CSMwrap: VGA emulator state after csmwrap_video_init:\n");
	cbvga_emul_dump_state();
	...
	// Dump emulator state after SeaVGABIOS Option ROM dispatch
	printf("CSMwrap: VGA emulator state after SeaVGABIOS dispatch:\n");
	cbvga_emul_dump_state();
	...
	// Optional: dump emulator state before Legacy16Boot handoff
	printf("CSMwrap: VGA emulator state before Legacy16Boot:\n");
	cbvga_emul_dump_state();
